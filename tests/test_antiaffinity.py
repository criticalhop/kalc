...
def prepare_affinity_test_8_pods_on_3_nodes_with_6_antiaffinity_pods():
    ...
    pods[0].podsMatchedByAntiaffinity.add(pods[3])
    ...
    pods[1].podsMatchedByAntiaffinity.add(pods[3])
    ...
    pods[2].podsMatchedByAntiaffinity.add(pods[3])
    pods[2].podsMatchedByAntiaffinity_length = 3
    pods[2].target_number_of_antiaffinity_pods = 3

    pods[3].antiaffinity_set = True
    pods[3].podsMatchedByAntiaffinity.add(pods[1])
    pods[3].podsMatchedByAntiaffinity.add(pods[2])
    pods[3].podsMatchedByAntiaffinity.add(pods[0])
    pods[3].podsMatchedByAntiaffinity_length = 3
    pods[3].target_number_of_antiaffinity_pods = 3
    ...
    globalVar = next(filter(lambda x: isinstance(x, GlobalVar), k.state_objects))
    scheduler = next(filter(lambda x: isinstance(x, Scheduler), k.state_objects))
    class Antiaffinity_check_k1(Antiaffinity_check_with_add_node):
        pass
...
test_case.nodes[2].isSearched = True
test_case.pods[0].target_number_of_antiaffinity_pods = 3
test_case.globalVar.amountOfNodes_limit = 5
