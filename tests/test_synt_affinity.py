...
import pytest
import inspect
from guardctl.model.search import K8ServiceInterruptSearch,Antiaffinity_implement
...
def test_1_3pods_Service_outage():
    ...
    pod = build_running_pod_with_d(0,2,2,node_item,None,None,s1,pods)
    pod = build_running_pod_with_d(0,2,2,node_item,None,None,s1,pods)
    pod = build_running_pod_with_d(0,2,2,node_item,None,None,None,pods)
    pod = build_running_pod_with_d(0,2,2,node_item,None,None,None,pods)
    ...
    pod = build_running_pod_with_d(0,2,2,node_item,None,None,s1,pods)
    pod = build_running_pod_with_d(0,2,2,node_item,None,None,s2,pods)
    pod = build_running_pod_with_d(0,2,2,node_item,None,None,s2,pods)
