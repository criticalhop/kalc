...
# print_objects(k.state_objects)
test_case.globalVar.target_DeploymentsWithAntiaffinity_length = 2
...
class Antiaffinity_check_k2(Antiaffinity_check_with_limited_number_of_pods_with_add_node):
    pass
p2 = Antiaffinity_check_k2(k2.state_objects)
...
assert_brake = checks_assert_conditions_in_one_mode(k2,p2,assert_conditions,not_assert_conditions,"yaml test", DEBUG_MODE)