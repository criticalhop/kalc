...
# THis can't be used yet because of  BUG 131
    ...
    #     assert node_of_pod2 in node_of_pod4.different_than
    #     assert node_of_pod3 in node_of_pod4.different_than
    #     assert node_of_pod4 in node_of_pod1.different_than
    #     assert node_of_pod4 in node_of_pod2.different_than
    #     assert node_of_pod4 in node_of_pod3.different_than
    #     assert pod1 in deployment.podList
    #     assert pod2 in deployment.podList
    #     assert pod3 in deployment.podList
...
# THis can't be used yet because of  BUG 131
    ...
    #     assert node_of_pod3 in node_of_pod5.different_than
    #     assert node_of_pod4 in node_of_pod5.different_than
    #     assert node_of_pod5 in node_of_pod1.different_than
    #     assert node_of_pod5 in node_of_pod2.different_than
    #     assert node_of_pod5 in node_of_pod3.different_than
    #     assert node_of_pod5 in node_of_pod4.different_than
...
class Antiaffinity_check_with_limited_number_of_pods(Antiaffinity_check_basis):
    ...
    @planned(cost=1)
    def Reduce_calc_currently_processed_amount_of_deployment_pod_on_node(self,
        pod: Pod):
        pod.calc_currently_processed_amount_of_deployment_pod_on_node -= 1
